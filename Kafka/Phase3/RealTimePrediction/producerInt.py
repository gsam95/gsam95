...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("kafka_producerInt.log"),
...
def send_to_kafka(df, topic):
    ...
    try:
        for index, row in df.iterrows():
            ...
            time.sleep(1) #assuming this is equivalent to hour for this assignment # Microsecond delay (use `time.sleep(3600)` for actual hourly simulation)
...
if __name__ == '__main__':
    try:
        ...
        file_path = "D:/Grace/CMU/Courses/Spring2025/OpAI/Assignment/1/integratedPipeline/AirQualityUCI2025.csv"  # Replace with your actual file path
